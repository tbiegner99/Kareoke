...
const StaticFlushBuffer = Buffer.from([
    protocol_js_1.Protocol.FrontendMessageCode.Flush,
    0x00,
    0x00,
    0x00,
    0x04,
...
const StaticTerminateBuffer = Buffer.from([
    protocol_js_1.Protocol.FrontendMessageCode.Terminate,
    0x00,
    0x00,
    0x00,
    0x04,
...
const StaticSyncBuffer = Buffer.from([
    protocol_js_1.Protocol.FrontendMessageCode.Sync,
    0x00,
    0x00,
    0x00,
    0x04,
            ...
            for (let i = 0; i < params?.length; i++) {
                ...
                if (dt) {
                    ...
                    if (typeof dt.encodeBinary === 'function') {
                        ...
                        v = dt.elementsOID
                            ? (0, stringify_arrayliteral_js_1.stringifyArrayLiteral)(v, queryOptions, dt.encodeText)
